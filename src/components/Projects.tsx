  ...
  return (
    <section id="projects" className="section nav-offset">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 overflow-x-auto snap-x md:overflow-visible md:snap-none">
          {visible.map((p, i) => (
            <motion.article
              key={p.title}
              ...
              className="group relative overflow-hidden rounded-2xl glass border border-[rgba(188,19,254,0.25)] will-change-transform snap-center"
